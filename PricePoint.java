...
public class PricePoint extends StockData {
   ...
   * @param previousClose the closing price of the previous trading day, must be positive
  ...
  public PricePoint(LocalDate date, double open, double high,
    ...
    requirePositive(previousClose, "PreviousClose");
    if (high < low)
  ...
  /**
   * Returns the percent change from previous to today.
   * @return percent change
   */
  public double getPercentChange(double previousClose) {
    if (previousClose <= 0)
