...
public class ModelDemo {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("\nTesting PricePoint");
    PricePoint p1 = new PricePoint(LocalDate.of(2025, 8, 29),
        178.11 , 178.15, 173.15, 174.18, 243_260_000L);
    PricePoint p2 = new PricePoint(LocalDate.of(2025, 9, 2),
        170.00, 172.38, 167.22, 170.78, 231_160_000L);
    PricePoint p3 = new PricePoint(LocalDate.of(2025, 9, 3),
        171.06, 172.41, 168.88, 170.62, 164_420_000L);  // big gain — earnings day
    PricePoint p4 = new PricePoint(LocalDate.of(2025, 9, 4),
        170.57, 171.84, 169.41, 171.66, 141_670_000L);
    PricePoint p5 = new PricePoint(LocalDate.of(2025, 9, 5),
        168.03, 169.03, 164.07, 167.02, 224_440_000L);  // drop — macro sell-off
    ...
    System.out.println("  O→C Change   : " + String.format("%.2f%%", p3.getOpenToCloseChange()));
    ...
    prices.add(p1); prices.add(p2); prices.add(p3);
    prices.add(p4); prices.add(p5);
    ...
    AnalysisResult.AnomalyPoint gainAnomaly = new AnalysisResult.AnomalyPoint(
        p3, -0.09, sep3Events,
        "Normal trading day; move of -0.09% is below the 5% significance threshold.");
    ...
    AnalysisResult.AnomalyPoint lossAnomaly = new AnalysisResult.AnomalyPoint(
        p5, -2.70, sep5Events,
        "Normal trading day; move of -2.70% is below the 5% significance threshold..");

    System.out.println("  Gain anomaly : " + gainAnomaly);
    ...
    AnalysisResult result = new AnalysisResult(
        ...
        -2.20,
        anomalies,
        "NVDA lost 2.20% over the period. 2 significant moves detected: a sell-off on Sep 5 due to broad macro concerns, and regulatory concerns on Sep 4 regarding AI chip export restrictions to China.");
    ...
    try {
      new PricePoint(null, 480, 492, 478, 489, 18_000_000);
